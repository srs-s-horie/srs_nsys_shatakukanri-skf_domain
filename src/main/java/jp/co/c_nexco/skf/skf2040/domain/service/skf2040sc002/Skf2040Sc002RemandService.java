 ...
 */
@Service
public class Skf2040Sc002RemandService extends SkfServiceAbstract<Skf2040Sc002RemandDto> {
	...
	public BaseDto index(Skf2040Sc002RemandDto remDto) throws Exception {
		...
		boolean checkResults = skfAttachedFileUtils.attachedFileSessionConflictCheck(remDto.getApplNo());
		...
		if (!checkResults) {			
			...
			ServiceHelper.addErrorResultMessage(remDto, null, MessageIdConstant.I_SKF_1005,"セッション情報が異なっ","ブラウザを閉じて操作をやり直","");
