...
/**
 * Skf2040Sc002 退居（自動車の保管場所返還（アウトソース用）届）のPDF出力処理の基盤Dto。
 * 
 * @author NEXCOシステムズ
 */
@lombok.Data
@EqualsAndHashCode(callSuper = true)
public class Skf2040OutputPdfBaseDto extends FileDownloadDto {
	...
	/**
	 * 以下、Skf2010CommonDtoの要素
	 */
	/** 基本データ **/
	private String applNo; // 申請番号
	private String applId; // 申請ID
	private String applStatusText; // 申請状況（テキスト）
