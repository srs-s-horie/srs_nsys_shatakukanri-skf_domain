...
import jp.co.c_nexco.skf.skf2100.domain.dto.skf2100sc003.Skf2100Sc003CancelDto;

/**
 * Skf2100Sc001 モバイルルーター返却申請書（申請者用)取下げ処理クラス
 *
 * @author NEXCOシステムズ
 */
@Service
public class Skf2100Sc003CancelService extends SkfServiceAbstract<Skf2100Sc003CancelDto> {
	 ...
	 */
	@Override
	public Skf2100Sc003CancelDto index(Skf2100Sc003CancelDto saveDto) throws Exception {
		// 操作ログを出力する
		skfOperationLogUtils.setAccessLog("取下げ", CodeConstant.C001, FunctionIdConstant.SKF2100_SC003);
