...
import jp.co.c_nexco.skf.skf2100.domain.dto.skf2100sc001.Skf2100Sc001CancelDto;

/**
 * Skf2100Sc001 モバイルルーター借用希望申請書（申請者用)取下げ処理クラス
 *
 * @author NEXCOシステムズ
 */
@Service
public class Skf2100Sc001CancelService extends SkfServiceAbstract<Skf2100Sc001CancelDto> {
	 ...
	 */
	@Override
	public Skf2100Sc001CancelDto index(Skf2100Sc001CancelDto saveDto) throws Exception {
		// 操作ログを出力する
		skfOperationLogUtils.setAccessLog("取下げ", CodeConstant.C001, FunctionIdConstant.SKF2100_SC001);
		...
		// 正常終了
		ServiceHelper.addResultMessage(saveDto, MessageIdConstant.I_SKF_2038);
