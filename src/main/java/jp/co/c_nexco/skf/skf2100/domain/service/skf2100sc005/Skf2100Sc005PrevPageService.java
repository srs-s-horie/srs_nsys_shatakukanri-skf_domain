...
import jp.co.c_nexco.skf.skf2100.domain.dto.skf2100sc005.Skf2100Sc005PrevPageDto;

/**
 * Skf2100Sc005PrevPageService 戻るサービス処理クラス。
 * 
 * @author NEXCOシステムズ
 */
@Service
public class Skf2100Sc005PrevPageService extends SkfServiceAbstract<Skf2100Sc005PrevPageDto> {
	 ...
	 */
	@Override
	public Skf2100Sc005PrevPageDto index(Skf2100Sc005PrevPageDto prevPageDto) {

		// デバッグログ
		LogUtils.debugByMsg("戻る");
		// 操作ログを出力する
		skfOperationLogUtils.setAccessLog("戻る", CodeConstant.C001, FunctionIdConstant.SKF2100_SC005);
