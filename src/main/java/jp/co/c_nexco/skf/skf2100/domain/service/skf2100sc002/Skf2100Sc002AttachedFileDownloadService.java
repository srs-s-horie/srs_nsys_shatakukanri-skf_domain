...
import jp.co.c_nexco.skf.skf2100.domain.dto.skf2100sc002.Skf2100Sc002AttachedFileDownloadDto;

/**
 * Skf2100Sc002 モバイルルーター借用希望申請書（アウトソース用)添付ファイルダウンロードサービス処理クラス。
 * 
 * @author NEXCOシステムズ
 */
@Service
public class Skf2100Sc002AttachedFileDownloadService extends SkfServiceAbstract<Skf2100Sc002AttachedFileDownloadDto> {
	...
	@Override
	protected BaseDto index(Skf2100Sc002AttachedFileDownloadDto dlDto) throws Exception {
