 ...
 */
@Service
public class Skf3020Sc002InitService extends SkfServiceAbstract<Skf3020Sc002InitDto> {
	...
	public Skf3020Sc002InitDto index(Skf3020Sc002InitDto initDto) throws Exception {
		...
		if (NfwStringUtils.isNotEmpty(initDto.getPrePageId())
				&& Objects.equals(initDto.getPrePageId(), FunctionIdConstant.SKF3020_SC004)) {
