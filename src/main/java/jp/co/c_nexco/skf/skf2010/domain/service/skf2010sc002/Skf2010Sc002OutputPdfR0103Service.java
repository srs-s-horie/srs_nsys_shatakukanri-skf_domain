...
/**
 * Skf2010Sc002 申請書類確認画面の退居（自動車の保管場所返還）届（Skf2040Rp001）PDF出力処理クラス。
 * 
 * @author NEXCOシステムズ
 */
@Service
public class Skf2010Sc002OutputPdfR0103Service extends OutputPdfR0103BaseService<Skf2010Sc002OutputPdfR0103Dto> {
	 ...
	 */
	@Override
	protected void beforeIndexProc(Skf2010Sc002OutputPdfR0103Dto dto) {
		// 操作ログを出力する
		skfOperationLogUtils.setAccessLog("退居（自動車の保管場所返還）届PDF出力", CodeConstant.C001, FunctionIdConstant.SKF2010_SC002);
	}
}
