 ...
 */
@Service
public class Skf2010Sc002OutputPdfR0100Service extends OutputPdfR0100BaseService<Skf2010Sc002OutputPdfR0100Dto> {
	...
	protected void beforeIndexProc(Skf2010Sc002OutputPdfR0100Dto dto) {
		// 操作ログを出力する
		skfOperationLogUtils.setAccessLog("社宅入居希望等調書PDF出力", CodeConstant.C001, FunctionIdConstant.SKF2010_SC002);
	}
}
