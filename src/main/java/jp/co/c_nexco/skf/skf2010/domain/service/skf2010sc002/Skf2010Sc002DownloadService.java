 ...
 */
@Service
public class Skf2010Sc002DownloadService extends SkfServiceAbstract<Skf2010Sc002DownloadDto> {
	...
	protected BaseDto index(Skf2010Sc002DownloadDto dlDto) throws Exception {
		...
		// 操作ログを出力する
		skfOperationLogUtils.setAccessLog(fileName, CodeConstant.C001, FunctionIdConstant.SKF2010_SC002);
