 ...
 */
@Service
public class Skf2060Sc004InitService extends SkfServiceAbstract<Skf2060Sc004InitDto> {
	...
	private void setInitInfo(Skf2060Sc004InitDto initDto) {
		...
		sessionParam = (Skf2060Sc004GetKariageListExpParameter) sessionBean
				.get(SessionCacheKeyConstant.SKF2060SC004_SEARCH_COND_SESSION_KEY);
		...
		if (sessionParam != null) {
			...
			// 提示日From
			DateTimeFormatter format = DateTimeFormatter.ofPattern(SkfCommonConstant.YMD_STYLE_YYYYMMDD_FLAT);
