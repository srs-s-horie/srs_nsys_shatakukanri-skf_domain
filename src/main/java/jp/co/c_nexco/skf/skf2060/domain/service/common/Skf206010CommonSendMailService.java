...
public class Skf206010CommonSendMailService {
	...
	public SkfShinseiUtilsGetApplHistoryInfoByApplNoExp getApplInfo(String applNo) {
		SkfShinseiUtilsGetApplHistoryInfoByApplNoExpParameter param = new SkfShinseiUtilsGetApplHistoryInfoByApplNoExpParameter();
	...
	private String getApproveCommentStr(String applNo) {
		...
		commentList = skfCommentUtils.getCommentInfo(CodeConstant.C001, applNo, CodeConstant.STATUS_KAKUNIN_IRAI // 「確認依頼」ステータスのコメントを取得
		);
		String comment = "";
	 ...
	 * @throws Exception
	 */
	private void sendKariageTeijiMail(String applNo, Date applDate, String applShainName, String comment,
			String urlBase, String mailAddress, String applName) throws Exception {
