...
public class Skf2020Sc002ConfirmService extends BaseServiceAbstract<Skf2020Sc002ConfirmDto> {
	...
	// dto.addLastUpdateDate(Skf2020Sc002SharedService.KEY_LAST_UPDATE_DATE,
	...
	// // 入居希望等調書申請の更新処理
	// registNyukyoCount =
	// skf2020Sc002SharedService.updateNyukyoChoshoTsuchi(setValue, dto,
	// applInfo);
	...
	// * @return
	// */
	// private int updateApplHistoryAgreeStatusIchiji(Skf2010TApplHistory
	...
	// // 排他制御用更新日取得
	// // 更新日付を取得する
	// Skf2010TApplHistory resultUpdateDate =
	// skf2020Sc002SharedService.selectByApplHistoryPrimaryKey(setValue, dto);
	...
	// // 更新値の設定
	// setValue =
	// skf2020Sc002SharedService.setUpdateApplHistoryAgreeStatusIchiji(setValue,
	// dto, applInfo);
	// // 更新
	// resultCnt =
	// skf2020Sc002UpdateApplHistoryAgreeStatusExpRepository.updateApplHistoryAgreeStatus(setValue);
	//
	// return resultCnt;
	// }
}
