 ...
 */
@Service
public class Skf3021Sc001SearchService extends SkfServiceAbstract<Skf3021Sc001SearchDto> {
	...
	public Skf3021Sc001SearchDto index(Skf3021Sc001SearchDto searchDto) throws Exception {
		...
		// 操作ログを出力する
		skfOperationLogUtils.setAccessLog("検索", CodeConstant.C001, FunctionIdConstant.SKF3021_SC001);
