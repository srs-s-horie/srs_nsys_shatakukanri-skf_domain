...
public class Skf3010Sc006ChangeAreaDrpDwnAsyncService
		extends SkfAsyncServiceAbstract<Skf3010Sc006ChangeAreaDrpDwnAsyncDto> {
	...
	public AsyncBaseDto index(Skf3010Sc006ChangeAreaDrpDwnAsyncDto asyncDto) throws Exception {
		...
		// 操作ログを出力する
		skfOperationLogUtils.setAccessLog("地域区分変更", CodeConstant.C001, FunctionIdConstant.SKF3010_SC006);
		// デバッグログ
		logger.debug("地域区分変更");
		/** DTO設定用 */
		// 次回算定年月日
