 ...
 */
@Service
public class Skf3010Sc006InitService extends SkfServiceAbstract<Skf3010Sc006InitDto> {
	...
	public Skf3010Sc006InitDto index(Skf3010Sc006InitDto initDto) throws Exception {
		...
		logger.info("初期表示");
		// 操作ログを出力する
		skfOperationLogUtils.setAccessLog("初期表示", CodeConstant.C001, FunctionIdConstant.SKF3010_SC006);
		// 初期化
